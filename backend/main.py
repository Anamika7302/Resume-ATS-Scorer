...
MODEL_PATH = str(BASE_DIR / "models1"/"finetuned-bert") 
...
async def lifespan(app: FastAPI):
    ...
    logger.info(f'Loading SentenceTransformer from local path: {MODEL_PATH}')
    app.state.embedder = SentenceTransformer(MODEL_PATH)
